...
export function SelectComponent({ value, onValueChange, defaultValue, id, children, 'data-testid': dataTestId, ...props }: SelectProps) {
  return (
    <SelectPrimitive.Root
      ...
      {...props}
    >
      <SelectPrimitive.Trigger id={id} data-testid={dataTestId} />
